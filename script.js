const students = [
    { ID: 1, name: 'Atif', age: 21, grade: 'A', degree: 'B.tech', email: 'Atif123@example.com' },
    { ID: 2, name: 'Mamoor', age: 22, grade: 'B', degree: 'B.tech', email: 'mamoor321@example.com' },
    { ID: 3, name: 'Taha', age: 20, grade: 'C', degree: 'B.tech', email: 'taha@example.com' }
  ];
